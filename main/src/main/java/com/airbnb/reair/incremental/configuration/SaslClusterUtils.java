...
public class SaslClusterUtils {
  ...
  public static void tokensInit(Credentials credentials, Configuration jobConfig) throws TokenInitException {
    try {
  ...
  public static void initMetastoreDelegationToken(
          URI metastoreUri, String signature, String principal, Credentials credentials) throws Exception {
  ...
  public static IMetaStoreClient getMetastoreClient(
          URI uri, String signature, String principal, Configuration conf) throws Exception {
